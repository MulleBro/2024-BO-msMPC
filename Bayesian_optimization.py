...
# INPUTS
# =============================================================================
n_inits = 3 #initialization points per dimension
n_iter=200 #BO iterations after initialization
kappa_value=1.96

n_runs=100 # number of investigated sets of parameters (drawn from uniform distribution)

# =============================================================================
# BOUNDS AND INITIALIZATION POINTS
# =============================================================================
#kX
lb_x=0
ub_x=10
...
#kX
p_inits=np.linspace(lb_x,ub_x,n_inits+2)
p_inits=p_inits[1:-1]


#kP
p_inits1=np.linspace(lb_x1,ub_x1,n_inits+2)
p_inits1=p_inits1[1:-1]

#Ks_Xyl_X
p_inits2=np.linspace(lb_x2,ub_x2,n_inits+2)
p_inits2=p_inits2[1:-1]
...
logger = JSONLogger(path="./BO/logs/BO_log")
...
for i in range(n_iter):
    ...
    delli[0]=next_point_to_probe['kX']  
    delli[1]=next_point_to_probe['kP']
    delli[2]=next_point_to_probe['Ks_Xyl_X']

    
    sp = do_mpc.sampling.SamplingPlanner()
    sp.set_param(overwrite = True)
    sp.data_dir = './BO/sample_plan_3D_c_opt/'
    ...
    sp.export('BO_plan_3D_c_opt_'+str(jjj))
 

    sampler = do_mpc.sampling.Sampler(plan)
    sampler.set_param(overwrite=True)
    sampler.data_dir = './BO/sample_res_3D_c_opt'+str(i)+'/'
    ...
    dh.data_dir = './BO/sample_res_3D_c_opt'+str(i)+'/'
